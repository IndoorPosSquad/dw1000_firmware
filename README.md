...
Message传输: (从 RX 到 TX , Payload 需要为64Bytes)

```bash
echo -e "M\x40\x01\x00\x00\x00\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xF1\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x00123456789012345678901234567890123456789012345678901234567890123CC" > /dev/ttyUSB0
```
...
TYPE : "M"
LEN   : \0x40
SEQ  : \0x01\0x00\0x00\0x00
SRC  : \0xFF\0xFF\0xFF\0xFF\0xFF\0xFF\0xFF\0xF1
DST  : \0xFF\0xFF\0xFF\0xFF\0xFF\0xFF\0xFF\0x00
PAYLOAD:  1234567890......
CRC  : CC
```
